...
task main()
{
	...
	while(1 == 1)
	{
		...
		//End Regular Controls

		// Start Forward Driving Controls
		...
		//Start Backwards Driving Controls
		...
		//Start Turn Right Driving Controls
		...
		//Start Turn Left Driving Controls
		...
		//End Turn Left Driving Controls
